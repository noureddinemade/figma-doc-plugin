...
export const fontBold  = { family: "IBM Plex Mono", style: "Medium" };
...
export const compFrame      = new Frame('VERTICAL', 16, 0, 0, null, null, null);
export const innerFrame     = new Frame('VERTICAL', 8, 0, 0, null, null, null);
export const innerFrameAlt  = new Frame('HORIZONTAL', 8, 0 , 0, null, null, null);
...
export const itemFrame      = new Frame('HORIZONTAL', 16, 0, 0, null, {p:'MIN', s:'CENTER'}, null);
