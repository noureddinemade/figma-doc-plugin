...
export const iconVector        = {
    ...
    BOOLEAN:    [icon.BOOLEAN, fillGrey, strokeNone, strokeWeightNone],
    TEXT:       [icon.TEXT, fillGrey, strokeNone, strokeWeightNone],
    VARIANT:    [icon.VARIANT, fillGrey, strokeNone, strokeWeightNone],
    DEPENDENCY: [icon.DEPENDENCY, fillGrey, strokeNone, strokeWeightNone]
